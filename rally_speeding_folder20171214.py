...
#                if first == True :
#                    print ('{4}\nclosest to start: Point {0} at {1} meters, closest to finish: Point {2} at {3} meters'.format(closest_to_start, closest_to_start_meters, closest_to_finish, closest_to_finish_meters, file))
#                    first = False
